...
$sections = [
    ['title' => '1. Topladığımız Bilgiler', 'body' => 'Belge oluşturma sırasında girdiğiniz ad-soyad, adres, tarih, tutar gibi bilgiler yalnızca talep ettiğiniz belgeyi oluşturmak amacıyla işlenir. Hesap oluşturmanız halinde e-posta adresiniz ve şifrelenmiş şifreniz saklanır. Ayrıca IP adresi, tarayıcı bilgisi ve site içi gezinme verileri otomatik olarak toplanabilir.'],
    ...
    ['title' => '3. Belge İçeriği Verilerinin Saklanması', 'body' => 'Misafir olarak oluşturduğunuz belgeye ait form bilgileri yalnızca PDF oluşturmak için bu istek sırasında işlenir; PDF indirildikten sonra belge geçmişi olarak saklanmaz ve yeniden düzenlenemez. Oturum açmış kullanıcıların belge form bilgileri, Belgelerim alanından tekrar erişip düzenleyebilmesi amacıyla 30 gün saklanır ve bu süre sonunda otomatik olarak silinir. Kayıtlı kullanıcılar belgelerini bu süreden önce Belgelerim alanından silebilir.'],
